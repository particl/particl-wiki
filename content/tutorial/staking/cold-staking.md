...
<label type="info">Note</label> Pool public keys begin with `pcs` and usually look similar to this:
```
...
<label type="info">Note</label> Public keys generated by Partyman begin with `PPART` and usually look similar to this:
```
